...
smoke-test:
	@mkdir -p build
	tinygo build -target pico-w -size short -o build/test.uf2 ./rp2-pio/examples/rmii
	tinygo build -target pico2  -size short -o build/test.uf2 ./rp2-pio/examples/rmii
	...
	tinygo build -target pico2 -size short -o build/test.uf2 ./rp2-pio/examples/parallel/hub40screen
